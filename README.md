...
<b><span style="style="font-size:30px">Front-end:</b>  HTML, CSS, JavaScript, BootStrap | <b>Banck-end:</b> C#, Java, Python | <b>DataBase:</b> MySQL <br>
<b>Languages:</b> English (advanced) and Portuguese (native)
